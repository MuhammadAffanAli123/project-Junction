        ...
        return (
            <div className='stu-dashboard'>
                ...
                <Col>
                        ...
                        <Form.Label className='address' style={{maxWidth:'30%',marginLeft:"32.5%"}}><b>Project Category</b></Form.Label>
          ...
          <input placeholder="Search" style={{maxWidth:'30%',marginLeft:"33%"}} 
            type="text"
